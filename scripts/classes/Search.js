...
export function onSearchPageLoad(doc) {
    console.log("Search has been loaded");
    expandButton = doc.querySelector(".expand-button");
    filterSection = doc.querySelector(".filter-section");
    galleryCards = doc.querySelectorAll(".card");
    deceasedFilter = doc.querySelector("#Deceased");
    activeFilterList = doc.querySelector(".active-filters");
    ...
    game.characterPopout.characterSearch = doc;
}
