...
function convertAllToObjects() {
	...
	function addNewWaypoint(color, name, container){
		...
		//update the collection, which stores everything in the settings
		trackerCollection.updateCollection();
		let waypointTemplate = ` <div class="draggableWaypoint">
    <div class="handle">    <h1 class="waypointLabel">Hello How Are Ya</h1>
</div>
    <div class="line"></div>
</div>`
		let waypoint = document.createElement("div");
		waypoint.className = "draggableWaypoint";
	}
